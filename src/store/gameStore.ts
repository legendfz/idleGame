...
interface GameStore {
  ...
  autoAwaken: boolean; // v173.0: auto-allocate awakening points
  ...
  setAutoAwaken: (v: boolean) => void; // v173.0
...
export const useGameStore = create<GameStore>((set, get) => ({
  ...
  setAutoAwaken: (v: boolean) => set({ autoAwaken: v }),
