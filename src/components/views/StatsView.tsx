...
export function StatsView() {
  ...
  const stats = [
    ...
    { label: '修炼时长', value: formatTime(player.totalCultivateTime || 0), icon: '🧘' },
    { label: '最高伤害', value: (player.maxDamage || 0).toLocaleString(), icon: '💥' },
    { label: '装备掉落', value: (player.totalEquipDrops || 0).toString(), icon: '🎁' },
