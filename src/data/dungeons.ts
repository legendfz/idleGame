...
export const DUNGEONS: DungeonConfig[] = [
  {
    ...
    waves: [
      { type: 'minion', enemyName: '石精', enemyIcon: '[石]', count: 3, hp: 200, attack: 25, defense: 15 },
      { type: 'minion', enemyName: '山魈', enemyIcon: '[妖]', count: 2, hp: 300, attack: 30, defense: 10 },
      { type: 'minion', enemyName: '石精', enemyIcon: '[石]', count: 2, hp: 200, attack: 25, defense: 15 },
      { type: 'minion', enemyName: '山魈', enemyIcon: '[妖]', count: 2, hp: 300, attack: 30, defense: 10 },
      { type: 'minion', enemyName: '封印傀儡', enemyIcon: '[像]', count: 2, hp: 500, attack: 40, defense: 25 },
      { type: 'elite', enemyName: '五行石将', enemyIcon: '[峰]', count: 1, hp: 1200, attack: 60, defense: 40 },
      { type: 'elite', enemyName: '封印守卫', enemyIcon: '[盾]', count: 1, hp: 1500, attack: 50, defense: 60 },
    ],
    boss: {
      name: '五行山石灵',
      icon: '[峰]',
  ...
  },
  {
    ...
    waves: [
      { type: 'minion', enemyName: '水妖', enemyIcon: '[鱼]', count: 3, hp: 350, attack: 35, defense: 12 },
      { type: 'minion', enemyName: '蛟灵', enemyIcon: '[龙]', count: 2, hp: 500, attack: 45, defense: 18 },
      { type: 'minion', enemyName: '水妖', enemyIcon: '[鱼]', count: 3, hp: 350, attack: 35, defense: 12 },
      { type: 'minion', enemyName: '涧底虾兵', enemyIcon: '[虾]', count: 5, hp: 250, attack: 30, defense: 8 },
      { type: 'minion', enemyName: '蛟灵', enemyIcon: '[龙]', count: 3, hp: 500, attack: 45, defense: 18 },
      { type: 'elite', enemyName: '涧龙卫', enemyIcon: '[龙]', count: 1, hp: 2000, attack: 75, defense: 45 },
      { type: 'elite', enemyName: '水幕护法', enemyIcon: '[水]', count: 1, hp: 1800, attack: 65, defense: 55 },
    ],
    boss: {
      name: '小白龙',
      icon: '[龙]',
  ...
  },
  {
    ...
    waves: [
      { type: 'minion', enemyName: '猪妖小兵', enemyIcon: '[猪]', count: 3, hp: 500, attack: 50, defense: 20 },
      { type: 'minion', enemyName: '野猪精', enemyIcon: '[猪]', count: 2, hp: 700, attack: 60, defense: 30 },
      { type: 'minion', enemyName: '猪妖小兵', enemyIcon: '[猪]', count: 4, hp: 500, attack: 50, defense: 20 },
      { type: 'minion', enemyName: '野猪精', enemyIcon: '[猪]', count: 3, hp: 700, attack: 60, defense: 30 },
      { type: 'minion', enemyName: '猪妖小兵', enemyIcon: '[猪]', count: 2, hp: 500, attack: 50, defense: 20 },
      { type: 'elite', enemyName: '猪妖统领', enemyIcon: '[猪]', count: 1, hp: 3000, attack: 100, defense: 55 },
      { type: 'elite', enemyName: '高老庄护院', enemyIcon: '[力]', count: 1, hp: 2500, attack: 90, defense: 65 },
    ],
    boss: {
      name: '猪八戒',
      icon: '[猪]',
  ...
  },
  {
    ...
    waves: [
      { type: 'minion', enemyName: '沙蝎', enemyIcon: '[蝎]', count: 3, hp: 800, attack: 70, defense: 25 },
      { type: 'minion', enemyName: '流沙鬼卒', enemyIcon: '[骷]', count: 2, hp: 1000, attack: 80, defense: 35 },
      { type: 'minion', enemyName: '沙蝎', enemyIcon: '[蝎]', count: 4, hp: 800, attack: 70, defense: 25 },
      { type: 'minion', enemyName: '流沙鬼卒', enemyIcon: '[骷]', count: 3, hp: 1000, attack: 80, defense: 35 },
      { type: 'minion', enemyName: '沙蝎', enemyIcon: '[蝎]', count: 2, hp: 800, attack: 70, defense: 25 },
      { type: 'elite', enemyName: '河底蛟龙', enemyIcon: '[鳄]', count: 1, hp: 4000, attack: 130, defense: 70 },
      { type: 'elite', enemyName: '沙暴魔将', enemyIcon: '[旋]', count: 1, hp: 3500, attack: 140, defense: 50 },
    ],
    boss: {
      name: '沙悟净',
      icon: '[沙]',
  ...
  },
  {
    ...
    waves: [
      { type: 'minion', enemyName: '毒蛇', enemyIcon: '[蛇]', count: 4, hp: 600, attack: 65, defense: 15 },
      { type: 'minion', enemyName: '蛇妖', enemyIcon: '[蛇]', count: 2, hp: 900, attack: 75, defense: 25 },
      { type: 'minion', enemyName: '毒蛇', enemyIcon: '[蛇]', count: 3, hp: 600, attack: 65, defense: 15 },
      { type: 'minion', enemyName: '蛇妖', enemyIcon: '[蛇]', count: 3, hp: 900, attack: 75, defense: 25 },
      { type: 'minion', enemyName: '毒蛇', enemyIcon: '[蛇]', count: 5, hp: 600, attack: 65, defense: 15 },
      { type: 'elite', enemyName: '蛇王卫士', enemyIcon: '[龙]', count: 1, hp: 3500, attack: 120, defense: 50 },
      { type: 'elite', enemyName: '毒雾蛇灵', enemyIcon: '[亡]', count: 1, hp: 3000, attack: 110, defense: 40 },
    ],
    boss: {
      name: '蟒蛇精',
      icon: '[蛇]',
  ...
  },
  {
    ...
    waves: [
      { type: 'minion', enemyName: '黄风小妖', enemyIcon: '[鼠]', count: 3, hp: 1000, attack: 85, defense: 30 },
      { type: 'minion', enemyName: '风蝠', enemyIcon: '[蝠]', count: 4, hp: 800, attack: 95, defense: 15 },
      { type: 'minion', enemyName: '黄风小妖', enemyIcon: '[鼠]', count: 2, hp: 1000, attack: 85, defense: 30 },
      { type: 'minion', enemyName: '风蝠', enemyIcon: '[蝠]', count: 2, hp: 800, attack: 95, defense: 15 },
      { type: 'minion', enemyName: '黄风小妖', enemyIcon: '[鼠]', count: 4, hp: 1000, attack: 85, defense: 30 },
      { type: 'elite', enemyName: '风暴鬼将', enemyIcon: '[旋]', count: 1, hp: 5000, attack: 160, defense: 70 },
      { type: 'elite', enemyName: '黄风先锋', enemyIcon: '[战]', count: 1, hp: 4500, attack: 150, defense: 80 },
    ],
    boss: {
      name: '黄风怪',
      icon: '[鼠]',
  ...
  },
  {
    ...
    waves: [
      { type: 'minion', enemyName: '火鸦', enemyIcon: '[火]', count: 3, hp: 1200, attack: 100, defense: 25 },
      { type: 'minion', enemyName: '炎魔兵', enemyIcon: '[魔]', count: 2, hp: 1500, attack: 110, defense: 40 },
      { type: 'minion', enemyName: '火鸦', enemyIcon: '[火]', count: 2, hp: 1200, attack: 100, defense: 25 },
      { type: 'minion', enemyName: '炎魔兵', enemyIcon: '[魔]', count: 3, hp: 1500, attack: 110, defense: 40 },
      { type: 'minion', enemyName: '火鸦', enemyIcon: '[火]', count: 5, hp: 1200, attack: 100, defense: 25 },
      { type: 'elite', enemyName: '铁扇公主', enemyIcon: '[妃]', count: 1, hp: 8000, attack: 180, defense: 90 },
      { type: 'elite', enemyName: '红孩儿', enemyIcon: '[子]', count: 1, hp: 7000, attack: 200, defense: 70 },
    ],
    boss: {
      name: '牛魔王',
      icon: '[牛]',
  ...
  },
  {
    ...
    waves: [
      { type: 'minion', enemyName: '蛛丝小妖', enemyIcon: '[蛛]', count: 3, hp: 1800, attack: 130, defense: 40 },
      { type: 'minion', enemyName: '毒蛛卫', enemyIcon: '[蛛]', count: 2, hp: 2200, attack: 150, defense: 50 },
      { type: 'minion', enemyName: '蛛丝小妖', enemyIcon: '[蛛]', count: 4, hp: 1800, attack: 130, defense: 40 },
      { type: 'minion', enemyName: '毒蛛卫', enemyIcon: '[蛛]', count: 3, hp: 2200, attack: 150, defense: 50 },
      { type: 'minion', enemyName: '蛛丝小妖', enemyIcon: '[蛛]', count: 3, hp: 1800, attack: 130, defense: 40 },
      { type: 'elite', enemyName: '蛛后护法', enemyIcon: '[网]', count: 1, hp: 8000, attack: 220, defense: 100 },
      { type: 'elite', enemyName: '丝网魔将', enemyIcon: '[网]', count: 1, hp: 7500, attack: 200, defense: 110 },
    ],
    boss: {
      name: '七蜘蛛精',
      icon: '[蛛]',
  ...
  },
  {
    ...
    waves: [
      { type: 'minion', enemyName: '狮驼小妖', enemyIcon: '[妖]', count: 3, hp: 2500, attack: 180, defense: 60 },
      { type: 'minion', enemyName: '象兵', enemyIcon: '[象]', count: 2, hp: 3000, attack: 160, defense: 90 },
      { type: 'minion', enemyName: '狮驼小妖', enemyIcon: '[妖]', count: 3, hp: 2500, attack: 180, defense: 60 },
      { type: 'minion', enemyName: '鹏妖卫', enemyIcon: '[鹰]', count: 3, hp: 2000, attack: 220, defense: 40 },
      { type: 'minion', enemyName: '象兵', enemyIcon: '[象]', count: 2, hp: 3000, attack: 160, defense: 90 },
      { type: 'elite', enemyName: '白象精', enemyIcon: '[象]', count: 1, hp: 12000, attack: 280, defense: 150 },
      { type: 'elite', enemyName: '青狮精', enemyIcon: '[狮]', count: 1, hp: 15000, attack: 320, defense: 130 },
    ],
    boss: {
      name: '大鹏金翅',
      icon: '[鹰]',
  ...
  },
  {
    ...
    waves: [
      { type: 'minion', enemyName: '金刚力士', enemyIcon: '[力]', count: 2, hp: 5000, attack: 300, defense: 150 },
      { type: 'minion', enemyName: '天兵', enemyIcon: '[战]', count: 3, hp: 4000, attack: 280, defense: 120 },
      { type: 'minion', enemyName: '金刚力士', enemyIcon: '[力]', count: 2, hp: 5000, attack: 300, defense: 150 },
      { type: 'elite', enemyName: '四大天王·增长', enemyIcon: '[冠]', count: 1, hp: 20000, attack: 400, defense: 200 },
      { type: 'elite', enemyName: '四大天王·广目', enemyIcon: '[冠]', count: 1, hp: 20000, attack: 380, defense: 220 },
      { type: 'elite', enemyName: '韦陀护法', enemyIcon: '[盾]', count: 1, hp: 30000, attack: 450, defense: 300 },
      { type: 'elite', enemyName: '观音化身', enemyIcon: '[佛]', count: 1, hp: 25000, attack: 500, defense: 250 },
    ],
    boss: {
      name: '如来考验',
      icon: '[轮]',
