/**
 * TutorialOverlay — v12.0 新手引导浮层
 */
import { useGameStore } from '../store/gameStore';

const STEPS = [
  { id: 1, icon: '📿', title: '开始修炼', desc: '战斗会自动进行，每秒获取灵石和经验。观察你的角色自动战斗吧！', tab: 'battle' as const },
  { id: 2, icon: '⚔️', title: '初战告捷', desc: '你已经在战斗了！击败敌人获取灵石和装备，变得更强！', tab: 'battle' as const },
  { id: 3, icon: '🎒', title: '装备强化', desc: '打开背包查看获得的装备，装备它们提升战力！', tab: 'bag' as const },
  { id: 4, icon: '⬆️', title: '境界突破', desc: '等级和蟠桃足够后，点击突破提升境界，属性大幅增长！', tab: 'battle' as const },
  { id: 5, icon: '🗺️', title: '踏上征途', desc: '查看成就系统，完成挑战获取额外奖励！', tab: 'achievement' as const },
];
...
export function TutorialOverlay() {
  ...
  return (
    <div style={{
      ...
      borderRadius: 12, padding: 14, boxShadow: '0 4px 20px rgba(0,0,0,0.6)',
    }}>
      <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 8 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12, color: '#aaa' }}>{step.desc}</div>
        </div>
      </div>
